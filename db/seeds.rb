...
cpost2 = CustomerPost.create(:content => "Tuan dang can tim nguoi day cho con nuoi cua anh ay", :subject => "Ly")
cpost3 = CustomerPost.create(:content => "Vinh dang can tim nguoi day cho nguoi yeu cua anh ay", :subject => "Ly")
